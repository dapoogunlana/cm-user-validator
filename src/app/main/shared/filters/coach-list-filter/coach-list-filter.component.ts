...
@Component({
  selector: 'app-coach-list-filter',
  templateUrl: './coach-list-filter.component.html',
  styleUrls: ['./coach-list-filter.component.scss']
})
export class CoachListFilterComponent implements OnInit, OnDestroy {
  ...
  resizeSpaceHolder(): void {
    setTimeout(() => {
      const filter: any = document.getElementById('coach_list_filter');
      const holder: any = document.getElementById('space_holder');
      holder.style.height = filter.clientHeight + 'px';
    }, 10);
  }
