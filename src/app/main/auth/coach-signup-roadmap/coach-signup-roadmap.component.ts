...
@Component({
  selector: 'app-coach-signup-roadmap',
  templateUrl: './coach-signup-roadmap.component.html',
  styleUrls: ['./coach-signup-roadmap.component.scss']
})
export class CoachSignupRoadmapComponent implements OnInit, OnDestroy {
